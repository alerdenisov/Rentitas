...
//                continue;
    ...
    private static void OnSelectedTypeName(object userData)
    {
        ...
        s_SelectedClassRef = TypeRef.GetStringRef(selectedType);
    ...
    {
        DrawTypeSelectionControl(position, property.FindPropertyRelative("_typeRef"), label, attribute as ClassTypeConstraintAttribute);
    }
