...
namespace Rentitas.Unity.VisualDebugging
{
    public class SystemInfo
    {
        ...
        public SystemInfo(ISystem system)
        {
            ...
            if (isReactive)
            {
                _interfaceFlags = getInterfaceFlags(reactiveSystem.InternalSubsystem, isReactive);
                systemType = reactiveSystem.InternalSubsystem.GetType();
            }
            else
            {
            ...
            var debugScenario = system as DebugScenario;
            if (debugScenario != null)
            {
                _systemName = debugScenario.Name;
            }
            else
            {
